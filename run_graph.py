...
from src.model.model_graph_cls import Baseline, LMForSequenceClassification, LMForSequenceClassification_multi_loss, \
    LMForSequenceClassification_softmax, LMForSequenceClassification_maxpooling, \
...
def create_model(args):
    ...
    # model = LMForSequenceClassification_multi_loss(
    # model = LMForSequenceClassification_maxpooling(
        config=config,
...
if __name__ == '__main__':
    ...
    ## baseline
    # cli_parser.add_argument("--output_dir", type=str, default="./KorSciBERT/baseline/merge_origin_preprocess_woCNJ") # acc: 89.81 F1: 90.04
    ...
    # cli_parser.add_argument("--output_dir", type=str, default="./KorSciBERT/cls/multi_loss/graph_concat_bilstm_coarse_alpha") # acc: 89.83 F1: 90.09
    # cli_parser.add_argument("--output_dir", type=str, default="./KorSciBERT/cls/softmax/graph_concat_coarse_alpha_again") # acc: 89 F1: 89.22
